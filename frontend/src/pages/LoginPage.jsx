  ...
  return (
    <div className="flex items-center justify-center h-screen font-body bg-gradient-to-br from-gray-100 via-gray-200 to-gray-300">
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
        <h2 className="text-2xl font-bold text-center text-gray-800 font-headline">Login</h2>
        ...
        <form className="mt-6" onSubmit={handleLogin}>
          ...
          <button
            type="submit"
            className="font-bold font-headline w-full py-2 mt-4 text-white bg-sky-600 rounded-md hover:bg-sky-700"
            disabled={loading}
          >
